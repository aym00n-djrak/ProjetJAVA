    ...
    Reservation(){
     ...
     //Appel de la methode MenuBar
       ...
       /* String pays[]={"Paris","Moscou","Londres","Berlin","Corée","Tokyo","Sydney","Floride","Brésil","Strasbourg","Bordeaux"};        
         JComboBox combo = new JComboBox(pays);
         combo.setBounds(150, 110,100,20);*/
        ...
        try {
            ...
            //Select dans la bdd
            String villebdd; 
            String url = "jdbc:mysql://sql11.freesqldatabase.com:3306/sql11479534";
            String requetecombo = "SELECT Nom FROM ville WHERE idVille > 0" ; //Sélectionner les noms dans la base de données ville
            bddconnect = DriverManager.getConnection(url, "sql11479534", "XKb4Tl5i6i");
            bddstatement = bddconnect.createStatement();
            ResultSet res = bddstatement.executeQuery(requetecombo);
            res.close();
            bddconnect.close();
      ...
      /*   JComboBox calendrier = new JComboBox();*/
         ...
         validate.addActionListener( this::confListener);
...
//Page informations diverses
    ...
    public void confListener( ActionEvent event ) {
